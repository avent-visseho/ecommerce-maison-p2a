...
class ProductAttributeController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'type' => 'required|in:select,color,text,checkbox',
            'is_active' => 'boolean',
        ]);
        ...
        return redirect()
            ...
            ->with('success', __('messages.admin.attribute.created'));
    }
    ...
    public function update(Request $request, ProductAttribute $attribute)
    {
        ...
        return redirect()
            ->route('admin.attributes.index')
            ->with('success', __('messages.admin.attribute.updated'));
    }
    ...
    public function destroy(ProductAttribute $attribute)
    {
        ...
        return redirect()
            ->route('admin.attributes.index')
            ->with('success', __('messages.admin.attribute.deleted'));
    }
    ...
    public function storeValue(Request $request, ProductAttribute $attribute)
    {
        ...
        return redirect()
            ...
            ->with('success', __('messages.admin.attribute_value.created'));
    }
    ...
    public function updateValue(Request $request, ProductAttribute $attribute, ProductAttributeValue $value)
    {
        ...
        return redirect()
            ->route('admin.attributes.values', $attribute)
            ->with('success', __('messages.admin.attribute_value.updated'));
    }
    ...
    public function destroyValue(ProductAttribute $attribute, ProductAttributeValue $value)
    {
        ...
        return redirect()
            ->route('admin.attributes.values', $attribute)
            ->with('success', __('messages.admin.attribute_value.deleted'));
    }
}
