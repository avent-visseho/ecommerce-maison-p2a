...
class Product extends Model
{
    ...
    /**
     * Attributs checkbox associés au produit.
     */
    public function checkboxAttributes(): BelongsToMany
    {
        return $this->belongsToMany(ProductAttribute::class, 'product_checkbox_attributes');
    }
