...
@section('title', 'Catégories de Location')
@section('page-title', 'Gestion des Catégories de Location')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-neutral-900">Catégories de Location</h2>
                <p class="text-sm text-neutral-400 mt-1">Organisez vos objets de location par catégorie</p>
            </div>
            <a href="{{ route('admin.rental-categories.create') }}" class="btn-primary flex items-center space-x-2">
            ...
            <div class="bg-white rounded-xl p-5 border border-neutral-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-neutral-900">{{ \App\Models\RentalCategory::count() }}</h3>
                    </div>
            ...
            <div class="bg-white rounded-xl p-5 border border-neutral-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-green-600">{{ \App\Models\RentalCategory::active()->count() }}</h3>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-blue-600">
                            {{ \App\Models\RentalCategory::whereNotNull('parent_id')->count() }}</h3>
                    </div>
                ...
                <div class="card group hover:shadow-md transition-all duration-200">
                    <div class="card-body">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center space-x-4 text-sm">
                                    <span class="flex items-center text-neutral-400">
                                        ...
                                        {{ $category->rentalItems()->count() }} objets
                                    </span>
                        ...
                        <div class="flex items-center space-x-2 pt-4 border-t border-neutral-200">
                            ...
                            <form action="{{ route('admin.rental-categories.destroy', $category) }}" method="POST"
                ...
                <div class="col-span-full">
                    <div class="card">
                        <div class="card-body text-center py-12">
                            ...
                            <p class="text-neutral-400 text-lg mb-2">Aucune catégorie de location trouvée</p>
