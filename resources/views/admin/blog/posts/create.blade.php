        ...
        <form action="{{ route('admin.blog.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="card">
                ...
                <div class="card-body space-y-5">
                    ...
                    <!-- Slug -->
                    <div>
                        <label for="slug" class="label">Slug (laisser vide pour génération automatique)</label>
                ...
                <div class="card-body space-y-5">
                    ...
                    <div>
                        ...
                        <select id="status" name="status" required
                            ...
                            <option value="scheduled" {{ old('status') == 'scheduled' ? 'selected' : '' }}>Planifié</option>
                        </select>
                        @error('status')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                ...
                <div class="card-body space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" name="meta_description" rows="3"
                            class="input-field @error('meta_description') border-red-500 @enderror">{{ old('meta_description') }}</textarea>
