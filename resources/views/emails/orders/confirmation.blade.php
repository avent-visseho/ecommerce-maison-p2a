                    ...
                    <tr>
                        <td style="background-color: #f9f5f2; padding: 32px 40px; text-align: center;">
                            ...
                            <p style="margin: 0; color: #2725a9; font-size: 14px; font-weight: 600;">
                                Lamaisonp2a@outlook.com | 0033 0782215485
                            </p>
                            <div style="margin: 24px 0 0 0;">
                                <a href="https://www.facebook.com/profile.php?id=61582522333813" style="display: inline-block; margin: 0 8px;">
                                    <img src="https://via.placeholder.com/24" alt="Facebook"
                                        style="width: 24px; height: 24px;">
                                </a>
                                <a href="https://www.instagram.com/lamaisonp2a?igsh=ZHg1czEwZ3JoOWlm&utm_source=ig_contact_invite" style="display: inline-block; margin: 0 8px;">
