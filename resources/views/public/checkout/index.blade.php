            ...
            <div class="flex items-center justify-center">
                <div class="flex items-center space-x-4">
                    <div class="flex items-center">
                        ...
                        <span class="ml-3 text-sm font-medium text-neutral-900">{{ __('checkout.cart') }}</span>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="ml-3 text-sm font-medium text-neutral-900">{{ __('checkout.shipping') }}</span>
                    </div>
                    <svg class="w-6 h-6 text-neutral-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                    <div class="flex items-center">
                        ...
                        <span class="ml-3 text-sm font-medium text-neutral-400">{{ __('checkout.payment') }}</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="lg:grid lg:grid-cols-3 lg:gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2 class="text-xl font-semibold text-neutral-900">{{ __('checkout.contact_info') }}</h2>
                            </div>
                            <div class="card-body space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="shipping_name" class="label">{{ __('checkout.full_name') }} <span
                                    ...
                                    <div>
                                        <label for="shipping_email" class="label">{{ __('checkout.email') }} <span
                                                class="text-red-500">*</span></label>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2 class="text-xl font-semibold text-neutral-900">{{ __('checkout.shipping_address') }}</h2>
                            </div>
                            <div class="card-body space-y-4">
                                <div>
                                    <label for="shipping_address" class="label">{{ __('checkout.full_address') }} <span
                                            class="text-red-500">*</span></label>
                                    <textarea id="shipping_address" name="shipping_address" rows="3" required placeholder="{{ __('checkout.address_placeholder') }}"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="shipping_city" class="label">{{ __('checkout.city') }} <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="shipping_postal_code" class="label">{{ __('checkout.postal_code') }}</label>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2 class="text-xl font-semibold text-neutral-900">{{ __('checkout.order_notes') }}</h2>
                            </div>
                            <div class="card-body">
                                <textarea id="notes" name="notes" rows="4" placeholder="{{ __('checkout.notes_placeholder') }}"
                    ...
                    <div class="mt-8 lg:mt-0">
                        <div class="card sticky top-24">
                            <div class="card-header">
                                <h2 class="text-xl font-semibold text-neutral-900">{{ __('checkout.your_order') }}</h2>
                            </div>
                            <div class="card-body">
                                <!-- Cart Items -->
                                        ...
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm font-medium text-neutral-900 truncate">
                                                    {{ $item['name'] }}</p>
                                                <p class="text-xs text-neutral-400">{{ __('checkout.quantity_label') }}: {{ $item['quantity'] }}</p>
                                            </div>
                                ...
                                <div class="space-y-3 py-4">
                                    ...
                                    <div class="pt-3 border-t border-neutral-200">
                                        <div class="flex justify-between text-xl font-bold">
                                            <span class="text-neutral-900">{{ __('checkout.total') }}</span>
                                ...
                                <div class="pt-4 border-t border-neutral-200 mb-6">
                                    <div class="bg-primary-50 rounded-lg p-4">
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-primary-900 mb-1">{{ __('checkout.secure_payment') }}</p>
                                                <p class="text-xs text-primary-700">
                                                    {{ __('checkout.fedapay_redirect') }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <button type="submit"
                                    ...
                                    <span>{{ __('checkout.proceed_to_payment') }}</span>
                                </button>
                                ...
                                <div class="pt-4 space-y-2">
                                    ...
                                    <div class="flex items-center text-xs text-neutral-600">
                                        ...
                                        {{ __('checkout.payment_by_fedapay') }}
                                    </div>
                                </div>
                            </div>
                        </div>
