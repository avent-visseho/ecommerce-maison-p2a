                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <svg class="h-8" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M19.5 21h-2.7l1.7-10.5h2.7L19.5 21zm11.3-10.2c-.5-.2-1.4-.4-2.4-.4-2.7 0-4.6 1.4-4.6 3.5 0 1.5 1.4 2.3 2.4 2.8 1.1.5 1.4.8 1.4 1.3 0 .7-.9 1-1.7 1-1.1 0-1.7-.2-2.6-.5l-.4-.2-.4 2.4c.6.3 1.8.6 3 .6 2.8 0 4.7-1.4 4.7-3.6 0-1.2-.7-2.1-2.3-2.9-1-.5-1.5-.8-1.5-1.3 0-.4.5-.9 1.6-.9.9 0 1.5.2 2 .4l.2.1.6-2.3zm6.7-.3h-2.1c-.7 0-1.1.2-1.4.8l-4 9.7h2.8l.6-1.6h3.5l.3 1.6h2.5l-2.2-10.5zm-3.4 6.8l1.1-3.1.3-.9.2.8.7 3.2h-2.3zM16.2 10.5L13.5 18l-.3-1.5c-.5-1.7-2.1-3.6-3.8-4.5l2.4 9h2.9l4.3-10.5h-2.8z" fill="#1a1f71"/>
                                <path d="M11.5 10.5H7.1l0 .2c3.4.9 5.7 3 6.6 5.5l-1-4.8c-.2-.7-.6-.9-1.2-.9z" fill="#f9a533"/>
                            </svg>
                            {{-- Mastercard --}}
                            <svg class="h-8" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="48" height="32" rx="4" fill="#fff" stroke="#e5e7eb"/>
                            ...
                            <svg class="h-8" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <text x="24" y="18" text-anchor="middle" fill="#fff" font-size="7" font-weight="bold" font-family="Arial">AMEX</text>
                            </svg>
                        </div>
                    </div>
